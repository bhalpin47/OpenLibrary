...
<div id="main" class="box">
    ...
    <div id="header">
     ...
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                ...
                <li id="active"><a href="booklist.htm">Browse Library<span class="tab-l"></span><span class="tab-r"></span></a></li>
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="index.jsp">Home</a> &gt;  <strong>Browse Library</strong> </p>
            <hr class="noscreen" />
		...
		<c:forEach items="${books}" var="b">
            ...
            <div class="article">
                ...
                <p>Add to:&nbsp;&nbsp;<strong><a href='addbookowned.htm?bid=<c:out value="${b.bookId}"/>'>Owned</a></strong>&nbsp;&nbsp;
               	<strong><a href='addbookread.htm?bid=<c:out value="${b.bookId}"/>'>Read</a></strong>&nbsp;&nbsp;
                <strong><a href='addbookwanted.htm?bid=<c:out value="${b.bookId}"/>'>Wishlist</a></strong></p>
            </div> <!-- /article -->
        ...
        <div id="col" class="noprint">
            <div id="col-in">
               ...
               <h3><span><a href="editprofile.htm">Edit Profile</a></span></h3>
                ...
                <ul id="category">
                    <li id="category-active"><a href="#">ISBN</a></li> <!-- Active -->
