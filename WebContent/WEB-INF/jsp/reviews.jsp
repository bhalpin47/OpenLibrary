...
<div id="main" class="box">
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="index.jsp"><strong>Home</strong></a> &gt;  <strong><a href="reviews.htm">Requests</a></strong></p>
            <hr class="noscreen" />
		...
		<c:forEach items="${reviews}" var="r">
			<c:if test="${r.book.statusCode == 'A'}">
            <!-- Article -->
            <div class="article">
                <h2><span><c:out value="${r.book.title}" /></span></h2>
                <p class="info noprint">
                    <span class="cat"><a href="#"><c:out value="${r.book.author}" /></a></span><span class="noscreen">,</span>
                    <span class="user"><a href="#"><c:out value="${r.book.user.username}" /></a></span><span class="noscreen">,</span>
                    <span class="comments"><a href='addreview.htm?bid=<c:out value="${r.book.bookId}"/>'>Review this book!</a></span>
                </p>
                ...
                <p class="info noprint"><strong>Rating:</strong> <c:out value="${r.rating}" />  
				 	<strong>Reviewer:</strong> <c:out value="${r.user.username}" /></p>
            </div> <!-- /article -->
