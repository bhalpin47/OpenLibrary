...
<div id="main" class="box">
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="index.jsp">Home</a> &gt;  Add Book &gt; <strong>Wishlist</strong> </p>
            <hr class="noscreen" />
        ...
        <form method="post" onsubmit="return validate()">
            ...
            <div class="article">
                ...
                <table>
                	...
                	<tr>
                    	<td><span class="cat">Publisher:<spring:bind path="command.book.publisher"></span>
						</td>
                    ...
                    <tr>                
                    	<td><span class="cat">ISBN:<spring:bind path="command.book.isbn"></span>
                    	</td>
						<td><input name='<c:out value="${status.expression}"/>'
                    ...
                    <tr><td><span class="cat">Pages:<spring:bind path="command.book.pages"></span>
						</td>	
						<td><input name='<c:out value="${status.expression}"/>'
                    ...
                    <tr>
                    	<td><span class="cat">Edition:<spring:bind path="command.book.edition"></span>
						</td>
						<td><input name='<c:out value="${status.expression}"/>'
								value='<c:out value="${status.value}"/>' type="text" id="edition" onClick="SelectAll('edition');" style="width:100px"/></spring:bind><span class="noscreen">
                    	</td>
                    </tr>
            	...
            	Note: This function adds a book to the library AND your Wish list, pending approval!<br/>
