...
<div id="main" class="box">
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="index.jsp">Home</a> &gt;  Add Book &gt;  <strong>Owned</strong> </p>
            <hr class="noscreen" />
        ...
        <div id="content">
            ...
            <div class="article">
                ...
                <h2><span>Title:<spring:bind path="command.book.title">
							...
							Author:<spring:bind path="command.book.author">
                ...
                <table>
                	...
                	<tr>
                    	<td><span class="cat">Publisher:<spring:bind path="command.book.publisher">
						</td>
                    ...
                    <tr>                
                    	<td><span class="cat">ISBN:<spring:bind path="command.book.isbn">
                    	</td>
						<td><input name='<c:out value="${status.expression}"/>'
                    ...
                    <tr><td><span class="cat">Pages:<spring:bind path="command.book.pages">
						</td>	
						<td><input name='<c:out value="${status.expression}"/>'
                    ...
                    <tr>
                    	<td><span class="cat">Edition:<spring:bind path="command.book.edition">
						</td>
						<td><input name='<c:out value="${status.expression}"/>'
                    ...
                    <tr>
                    	<td>Book Condition: <spring:bind path="command.bookCondition">
                    	</td>
							<td><select name='<c:out value="${status.expression}"/>'
								onChange='javascript:enabledButtons(this.name)'>
								<option value=""></option>
								<c:forEach items="${conditions}" var="condition">
									<option value='<c:out value="${condition.conditionCode}"/>'
										<c:if test="${condition.conditionCode == status.value}">SELECTED</c:if>>
                ...
                <p><spring:bind path="command.book.description">
                Description:
                <br/>
            ...
            Note: This function adds a book to the library AND your Owned list, pending approval!<br/>
              	<a href="addbook.htm">Click here</a> to add a book to just the Library.<br/>
