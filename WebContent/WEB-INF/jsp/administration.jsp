...
<div id="main" class="box">
    ...
    <div id="header">
        ...
        <!-- Logotyp -->
        <h1 id="logo"><a href="./" title="Administration">Open<strong>Library</strong><span></span></a></h1>
        <hr class="noscreen" />          
     ...
     <div id="tabs" class="noprint">
            ...
            <ul class="box">
                ...
                <li id="active"><a href="administration.htm">Admin<span class="tab-l"></span><span class="tab-r"></span></a></li>
                </c:if>          
			</ul>
    ...
    <div id="page-in" class="box">
        ...
        <div id="strip" class="box noprint">
            ...
            <!-- Breadcrumbs -->
            <p id="breadcrumbs">You are here: <a href="index.jsp"><strong>Home</strong></a> &gt;   <strong>Requests</strong></p>
            <hr class="noscreen" />
		...
		<c:forEach items="${command.books}" var="b" varStatus="tStatus">
            <!-- Article -->
            <div class="article">
                ...
                <spring:bind path="command.books[${tStatus.index}].statusCode">
                <strong><input name="${status.expression}" type="radio" value="Yes" <c:if test="${status.value == 'Yes'}">checked</c:if>>
                Approve&nbsp;&nbsp;
            	<input name="${status.expression}" type="radio" value="No" <c:if test="${status.value == 'No'}">checked</c:if>> 
            	Deny</strong>  
            	</spring:bind>
            </div> <!-- /article -->
        ...
        <p class="btn-more box noprint"><input name="cancel" type="button" value="Cancel"
					onClick="javascript:document.forms[0].reset()"><strong><input name="save" id="save" type="submit" value="Send"></strong></p>
      </form>
